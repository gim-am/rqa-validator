...
from rqa_validator.validators.data_validators.column_data_type_validator import DataTypeCheck
...
def schema_missing_sheet1():
    ...
    return BaseDatasetSchema(
        dataset_type="jmmi",
        schema_loaded_sheets=[SheetMapping(standard_name= "clean_dataxxx", 
...
def schema_missing_sheet2():
    ...
    return BaseDatasetSchema(
        ...
        schema_loaded_sheets=[SheetMapping(standard_name= "clean_data", 
                        ...
                        ,SheetMapping(standard_name="kobo_surveyxxx", 
...
def schema_missing_column1():
    ...
    return BaseDatasetSchema(
        ...
        schema_loaded_sheets=[SheetMapping(standard_name= "clean_data", 
                        ...
                        ,SheetMapping(standard_name="kobo_survey", 
                        alternate_names= ["survey"],
                        mandatory_columns = [ColumnMapping(standard_name='typexxx',
                                                           process_values=[ProcessValueMap(process_name='data_type_numeric_check',
                                                                                           values = ['integer', 'decimal']),
                                                                            ProcessValueMap(process_name='data_type_temporal_check',
                                                                                           values = ['date'])]),
        ...
        schema_loaded_sheets=[SheetMapping(standard_name= "clean_data", 
                        ...
                        mandatory_columns = [ColumnMapping(standard_name='type',
                                                           process_values=[ProcessValueMap(process_name='data_type_numeric_check',
                                                                            ...
                                                                            ProcessValueMap(process_name='data_type_temporal_check',
                                                                                           values = ['date'])]),
                                             ColumnMapping(standard_name= 'namexxx')]),                             
   ],
        schema_unloaded_sheets=[]
    )
...
def schema_missing_process1():
    ...
    return BaseDatasetSchema(
        ...
        schema_loaded_sheets=[SheetMapping(standard_name= "clean_data", 
                        ...
                        alternate_names= ["survey"],
                        mandatory_columns = [ColumnMapping(standard_name='type',
                                                           process_values=[ProcessValueMap(process_name='data_type_numeric_checkxxx',
                                                                                           values = ['integer', 'decimal']),
                                                                            ProcessValueMap(process_name='data_type_temporal_check',
                                                                                           values = ['date'])]),
                                             ColumnMapping(standard_name= 'name')]),                             
...
def valid_excel_data():
    ...
    df_clean = pl.DataFrame({
        ...
        "question3":['2026-01-01', '2026-01-01', '2026-01-01', '2026-01-01', '2026-01-01'],
...
def missing_column2():
    ...
    loaded_sheets = [SheetMap(
                        ...
                        data=df_survey,
                        data_columns=["type", "name"],
                        column_map=[ColumnMap(schema_column_name = 'typexxx',
                                   data_column_name='typexxx'),
                                   ColumnMap(schema_column_name = 'name',
                                   data_column_name='name')])]
...
def missing_column3():
    ...
    loaded_sheets = [SheetMap(
                        ...
                        column_map=[ColumnMap(schema_column_name = 'type',
                                   data_column_name='type'),
                                   ColumnMap(schema_column_name = 'namexxx',
                                   data_column_name='namexxx')])]
...
def invalid_excel_data2():
    ...
    df_clean = pl.DataFrame({
        ...
        "question1": ['1', '2', '3', '4', '5'],
        "question2":[1.5, 26.6, 3.7, 4.8, 5],
        "question3":['nope', '2026-01-01', '2026-01-01', '2026-01-01', '2026-01-01'],
        "other":['qwe', 'wer', 'qtr', 'asdf', '23432']
    })
...
class TestDataType:
    ...
    def test_missing_sheet_data(self, valid_schema_validator: BaseValidator,
                           missing_sheet: ExcelLoaderData):
        result = valid_schema_validator.validate(missing_sheet)
        
        assert isinstance(result, list)
        assert len(result) == 1

    def test_missing_sheet2_data(self, valid_schema_validator: BaseValidator,
                           missing_sheet2: ExcelLoaderData):
    ...
    def test_missing_column_data(self, valid_schema_validator: BaseValidator,
                           missing_column1: ExcelLoaderData):
        result = valid_schema_validator.validate(missing_column1)
        
        assert isinstance(result, list)
        assert len(result) == 1

    def test_missing_column2_data(self, valid_schema_validator: BaseValidator,
                           missing_column2: ExcelLoaderData):
        result = valid_schema_validator.validate(missing_column2)
        
        assert isinstance(result, list)
        assert len(result) == 1

    def test_missing_column3_data(self, valid_schema_validator: BaseValidator,
                           missing_column3: ExcelLoaderData):
        result = valid_schema_validator.validate(missing_column3)
        
        assert isinstance(result, list)
        assert len(result) == 1

    def test_missing_sheet1_schema(self, schema_missing_sheet1_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
    ...
    def test_missing_sheet2_schema(self, schema_missing_sheet2_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
    ...
    def test_missing_column1_schema(self, schema_missing_column1_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
    ...
    def test_missing_column2_schema(self, schema_missing_column2_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
    ...
    def test_missing_process1_schema(self, schema_missing_process1_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
    ...
    def test_missing_process2_schema(self, schema_missing_process2_validator: BaseValidator,
                           valid_excel_data: ExcelLoaderData):
